...
WAREHOUSE=$7
LOCATOR_PATH=${8:-/home/${USER}/sigmod25_artifact/}
...
if [ $OLAP_WORKER != 0 ] ; then
    ...
    ./ch_benchmark.py ${OLAP_WORKER} ${PGHOST} ${RAMPUP_TIME} ${file_name} ${BASE_POSTGRESQL_PATH} >> ./results/ch_benchmarks_${file_name}.log &
