...
#ifdef LOCATOR
static TM_Result
locatoram_tuple_update(Relation relation, ItemPointer otid, 
					LocatorTuplePosition tuplePosition, TupleTableSlot *slot,
					CommandId cid, Snapshot snapshot, Snapshot crosscheck,
					bool wait, TM_FailureData *tmfd,
					LockTupleMode *lockmode, bool *update_indexes)
{
...
static const TableAmRoutine locatoram_methods = {
	...
	/* Update tuple */
	.tuple_update_for_locator_partition = locatoram_tuple_update,
