...
#ifdef LOCATOR
int NLocatorMempartBuffers = LOCATOR_MEMPART_BUFFER_TOTAL_PAGE_COUNT;
int NLocatorMempartCount = LOCATOR_MEMPART_COUNT;
int LocatorMempartPageCount = LOCATOR_MEMPART_PAGE_COUNT;
int LocatorMempartStart = -1;
#endif /* LOCATOR */
