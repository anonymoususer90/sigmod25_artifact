...
{ /* using oldest snapshot */
	VERSION_INPROGRESS = -1,
	VERSION_UNFROZEN,	/*	xmin: committed,		xmax: in-progress		*/
	VERSION_INVISIBLE,	/*	xmin: committed,		xmax: committed 		*/
	VERSION_FROZEN,		/*	xmin: committed,		xmax: invalid(aborted)	*/
...
extern PrefetchDesc locator_create_prefetch_desc(Relation relation,
