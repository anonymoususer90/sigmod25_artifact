...
#ifdef LOCATOR
	/* see table_tuple_update() for reference about parameters */
	TM_Result	(*tuple_update_for_locator_partition) (Relation rel,
													   ItemPointer otid,
...
#ifdef LOCATOR
static inline TM_Result
table_tuple_update_for_locator_partition(Relation rel, ItemPointer otid, 
										 LocatorTuplePosition tuplePosition,
...
{
	return
		rel->rd_tableam->tuple_update_for_locator_partition(rel, otid, 
															tuplePosition, slot,
															cid, snapshot,
															crosscheck, wait,
															tmfd, lockmode,
...
#ifdef LOCATOR
extern const TableAmRoutine *GetLocatoramTableAmRoutine(void);
#endif /* LOCATOR */
