...
#endif
#ifdef LOCATOR
	B_LOCATOR_PARTITION_LAUNCHER,
	B_LOCATOR_PARTITION_WORKER,
	B_LOCATOR_BG_WRITER,
#endif
	B_ARCHIVER,
	B_LOGGER,
...
#endif
#ifdef LOCATOR
#define AmLocatorBackgroundWriterProcess() \
			(MyAuxProcType == LocatorBgWriterProcess)
#endif
