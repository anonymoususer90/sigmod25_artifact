...
#ifdef LOCATOR
	LocatorTuplePosition tts_tuple_position;
	int32 lvl_cnt;
	LocatorRouteSynopsis tts_locator_route_synopsis; /* key and positions of record */
	LocatorExecutor *tts_locator_executor;
#endif /* LOCATOR */
} TupleTableSlot;
...
#ifdef LOCATOR
extern void locator_init_columnar_slot(TupleTableSlot *slot,
									   Relation rel,
									   List *required_attidx_list);
extern void locator_init_columnar_slot_for_update(TupleTableSlot *slot,
												  Relation rel,
												  List *update_attidx_list,
												  List *returning_attidx_list);
extern void locator_init_columnar_slot_for_tuple_check(TupleTableSlot *slot,
													   Relation rel);
extern LocatorExecutorLevelDesc *locator_init_level_desc(
										LocatorExecutor *executor, int level);
extern void locator_prepare_materialize_for_update(TupleTableSlot *slot);
extern void locator_restore_isnull(TupleTableSlot *slot);
extern void locator_clear_executor(TupleTableSlot *slot);
#endif /* LOCATOR */
